...
// File: @openzeppelin/contracts/token/ERC20MD/IERC20.sol
...
/**
 * @dev Interface of the ERC20MD standard as defined in the EIP.
 */
interface IERC20 {
    /**
...
// File: contracts/child/ChildToken/UpgradeableChildERC20/ERC20MD.sol
 ...
 * and does not conflict with the expectations of ERC20MD applications.
 *
 ...
 */
contract ERC20MD is Context, IERC20 {
     ...
     * Ether and Wei. This is the value {ERC20MD} uses, unless {_setupDecimals} is
     * called.
     *
     ...
     * required by the EIP. See the note at the beginning of {ERC20MD};
     *
     * Requirements:
    ...
    function transferFrom(
        ...
        _approve(
            sender,
            _msgSender(),
            _allowances[sender][_msgSender()].sub(amount, "ERC20MD: transfer amount exceeds allowance")
        );
        return true;
    }
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        _approve(
            _msgSender(),
            spender,
            _allowances[_msgSender()][spender].sub(subtractedValue, "ERC20MD: decreased allowance below zero")
        );
        return true;
    }
    ...
    function _transfer(
        ...
        require(sender != address(0), "ERC20MD: transfer from the zero address");
        require(recipient != address(0), "ERC20MD: transfer to the zero address");

        _beforeTokenTransfer(sender, recipient, amount);

        _balances[sender] = _balances[sender].sub(amount, "ERC20MD: transfer amount exceeds balance");
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20MD: mint to the zero address");
    ...
    function _burn(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20MD: burn from the zero address");

        _beforeTokenTransfer(account, address(0), amount);

        _balances[account] = _balances[account].sub(amount, "ERC20MD: burn amount exceeds balance");
    ...
    function _approve(
        ...
        require(owner != address(0), "ERC20MD: approve from the zero address");
        require(spender != address(0), "ERC20MD: approve to the zero address");
...
contract UChildERC20 is ERC20MD, IChildToken, AccessControlMixin, NativeMetaTransaction, ChainConstants, ContextMixin {
    bytes32 public constant DEPOSITOR_ROLE = keccak256("DEPOSITOR_ROLE");

    constructor() public ERC20MD("", "") {}
